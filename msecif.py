...
def get_weighted_ecif(protein_pdb, ligand_sdf, distance_cutoff=6.0):
    ...
    pl_pairs['REC_SQR_DISTANCE'] = np.square(np.reciprocal(pl_pairs['DISTANCE']))
    feature = np.bincount(pl_pairs['ECIF_PAIR_ID'],
        weights=pl_pairs['REC_SQR_DISTANCE'],
